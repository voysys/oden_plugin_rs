...
use super::{vao, ShaderVersion};
use crate::{
    check_for_gl_error, log,
    oden_egui::misc_util::{compile_shader, link_program},
};
use egui::{
    emath::Rect,
...
impl Painter {
    ...
    pub fn new(
        ...
        let srgb_textures = shader_version == ShaderVersion::Es300
        ...
        unsafe {
            ...
            let vao = vao::VertexArrayObject::new(&gl, vbo, buffer_infos);
